function [arrRes]...
         =total_JS_Green1(MidPoint,NormalVector,Ind,MarkB,Miu,Rho,H,Omega,n,T,G)
...
u_minus_1 = matA_minus(:,1);
figure(1)
plot(u_minus_,real(u_minus_1(1:nPtS,:)),'b')
hold on
figure(2)
plot(u_minus_,imag(u_minus_1(1:nPtS,:)),'r--')
hold on

u_minus_ = 1:nPtS;
u_minus_1 = zeros(nPtS,1);
u_minus_1 = matA_plus(:,1);
figure(3)
plot(u_minus_,real(u_minus_1(1:nPtS,:)),'b')
hold on
figure(4)
