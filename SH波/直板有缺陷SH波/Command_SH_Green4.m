...
[MidPoint,ElemLen,NormalVector,midPoint,elemLen,normalVector,arrIndex,L_flaw_range,L_half_flaw,Mark,MarkB,LenExtend]=ElemMesh_MainFrame_LS_Green4(H,xC_flaw,WavLen,Nelem,Nwl);

[mat_r,mat_dr_D_dn,mat_r_,mat_dr_D_dn_,...
MidPoint_M,ElemLen_M,NormalVector_M,midPoint_M,elemLen_M,normalVector_M,arrIndex_M]...
=SUB_GeneGeoInfoNew_LS_Green4(arrX,MidPoint,ElemLen,NormalVector,midPoint,elemLen,normalVector,arrIndex);

[T,G]=GeneMat3(mat_r,mat_dr_D_dn,arrW,ElemLen_M,curOmega,Rho,Miu);

[t,g]=GeneMat3(mat_r_,mat_dr_D_dn_,arrW,elemLen_M,curOmega,Rho,Miu);

[arrRes] = total_JS_Green4(midPoint_M,normalVector_M,arrIndex_M,MarkB,Miu,Rho,H,curOmega,nPropMode,T,G,t,g);

x_plot_up = 1:arrIndex_M(2);
x_plot_low = 1:arrIndex_M(5)-arrIndex_M(2);
