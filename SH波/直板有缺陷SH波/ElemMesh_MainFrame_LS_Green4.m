function [MidPoint,ElemLen,NormalVector,midPoint,elemLen,normalVector,arrIndex,L_flaw_range,L_half_flaw,Mark,MarkB,LenExtend]=ElemMesh_MainFrame_LS_Green4(H,xC_flaw,WavLen,Nelem,Nwl)
...
[MidPointTemp,ElemLenTemp,NormalVectorTemp]=MakeElemInfo(ListPoints1);
MidPoint = [MidPoint;MidPointTemp];
ElemLen = [ElemLen;ElemLenTemp];
NormalVector = [NormalVector;NormalVectorTemp];
