function P_xba=Power_BA_ratio(w,cl,ct,a,b,k_b,h1)
 ...
 Txx=(a*(-(k_b^2+p^2)*sin(p*z))+2*b*(-k_b^2*sin(p*z)-1i*k_b*q*A2*sin(q*z)));
 Txz=(b*(2*1i*k_b*p*cos(p*z)+(k_b^2-q^2)*A2*cos(q*z)));
